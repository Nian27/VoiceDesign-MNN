...
# custom cache: deterministic seq length from kv_k, no min() symbolics
class StaticKVCache(DynamicCache):
...
try:
    ...
    torch.onnx.export(ep, (emb, pos, kk, vv, cp_), ART + '/graphb_dynamic_dynamo2.onnx', opset_version=18)
    print('ONNX OK', flush=True)
except Exception as e:
    import traceback; traceback.print_exc()
print('CUSTOMCACHE_DONE', flush=True)