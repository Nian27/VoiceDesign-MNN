// graphb_diag_probe_v4.cpp - 7 inputs / 21 outputs (k_all,k_T,qk_logits,qk_masked exposed)
// usage: graphb_diag_probe_v4 MODEL EMB CP KVK KVV COS SIN MASK OUT_DIR [cpu|htp]
...
int main(int argc, char** argv) {
    ...
    std::vector<std::string> outs = {"norm_out","q_raw","k_raw","v_raw","q_norm","k_norm","q_rope","k_rope",
                                     "k_all","k_T","qk_logits","qk_masked","attn_probs","attn_out","o_proj_out",
                                     "res1","post_norm","mlp_out","layer0_out","kv_k_out","kv_v_out"};
